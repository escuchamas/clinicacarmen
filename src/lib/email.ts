  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f0e8;padding:32px 16px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <!-- Cabecera -->
        <tr>
          <td style="background:#9B7B68;border-radius:12px 12px 0 0;padding:28px 32px;text-align:center;">
            <div style="display:inline-block;width:44px;height:44px;background:white;border-radius:10px;line-height:44px;font-size:22px;font-weight:900;color:#9B7B68;margin-bottom:12px;">C</div>
            <p style="margin:0;color:white;font-size:20px;font-weight:700;">Clínica Carmen</p>
            <p style="margin:4px 0 0;color:#D4C4BA;font-size:13px;">Fisioterapia</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="background:white;padding:32px;">
            ...
            <div style="background:#faf6f2;border-left:4px solid #9B7B68;border-radius:0 8px 8px 0;padding:16px 20px;margin-bottom:24px;">
              <p style="margin:0;font-size:13px;color:#6B4E3E;font-weight:600;">Información básica sobre protección de datos</p>
            </div>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
              ...
              <tr>
                ...
                <td style="padding:10px 0 10px 16px;">
                  <p style="margin:0;font-size:13px;color:#374151;">Puedes ejercer tus derechos de <strong>acceso, rectificación, supresión, oposición, limitación y portabilidad</strong> escribiendo a Carmen por WhatsApp o al correo electrónico de la clínica. También puedes presentar una reclamación ante la <a href="https://www.aepd.es" style="color:#9B7B68;">Agencia Española de Protección de Datos (aepd.es)</a>.</p>
                </td>
              </tr>
            </table>
